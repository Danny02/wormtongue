...
Draft revision (below) uses `output_config` for structured output. A non-Anthropic
endpoint has to support that too — if it doesn't, those requests fail and fall back
